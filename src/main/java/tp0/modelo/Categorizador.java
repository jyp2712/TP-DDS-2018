...
public class Categorizador {
	...
	// Se que esta inicializacion se ve fea pero es lo mas simple hasta que tengamos mas informacion.
	private List<Categoria> FCategorias = Arrays.asList(new Categoria("R1", 18.76, 0.644, 0, 150),
			...
			new Categoria("R8", 545.96, 0.851, 700, 1400), new Categoria("R9", 887.19, 0.851, 1400, 999999999/*QUE CARAJOS*/));
